...
training_dataset = "annotated_only" # "annotated_only" or "extended"
add_synthetic = True
if add_synthetic:
...
# remove rows with "None" label (not useful for training in the layered approach) 
...
output_dir=f"../models/llama3_finetuned/collectiveaction_sft_{training_dataset}_v{version_n}_prompt_v{prompt_v}_p{perc}{synthetic_tag}_{balanced}{synthetic_tag_more}{layered_tag}"
