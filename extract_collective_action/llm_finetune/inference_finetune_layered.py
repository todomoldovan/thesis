...
y_true = X_test.loc[:,'Label'].values
if prompt_v == 4:
...
predictions.to_csv(f"../data/predictions_finetune_{dpo_tag}v{version_n}_{training_dataset}_prompt_v{prompt_v}_p{perc}{synthetic_tag}_{balanced}{synthetic_tag_more}{layered_tag}.csv", index=False)
